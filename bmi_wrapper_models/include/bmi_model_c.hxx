#ifndef BMI_MODELC_H_INCLUDED
#define BMI_MODELC_H_INCLUDED
...
class NotImplemented : public std::logic_error {
  public:
  NotImplemented() : std::logic_error("Not Implemented Function in Model C") { };
};

}

class BmiModelC : public bmixx::Bmi {
...
private:
  model_c::parameters* state; // note #1: pointer to the structure "struct parameters" in the file model_c.hxx
                              // compare it with note #1 in the bmi_model_cxx.hxx
...
extern "C"
{
   ...
   */
  BmiModelC *bmi_model_create()
  {
    return new BmiModelC();
  }
   ...
   * @param ptr 
   */
  void bmi_model_destroy(BmiModelC *ptr)
  {
    delete ptr;
  }
